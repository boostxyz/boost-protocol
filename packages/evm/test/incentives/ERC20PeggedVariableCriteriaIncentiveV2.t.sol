...
/// @title ERC20PeggedVariableCriteriaIncentiveV2Test
/// @notice Tests for the updated ERC20PeggedVariableCriteriaIncentiveV2 contract with `maxReward` support
contract ERC20PeggedVariableCriteriaIncentiveV2Test is Test {
    ...
    /////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.initialize
    /////////////////////////////////////////////////

    function testInitialize() public {
        // Initialize the ERC20PeggedVariableCriteriaIncentiveV2 with a maxReward of 2 ether
    ...
    /////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.claim   //
    /////////////////////////////////////////////////
    ...
    function testClaim_ExceedsLimit() public {
        // Initialize the ERC20PeggedVariableCriteriaIncentiveV2
        _initialize(address(mockAsset), address(pegAsset), 1 ether, 5 ether, 0 ether, address(this));
    ...
    ///////////////////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.claim with maxReward //
    ///////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.preflight    //
    //////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.clawback
    //////////////////////////////////////////////
    ...
    function testGetIncentiveCriteria() public {
        ...
        // Check the peg address
        AERC20PeggedVariableCriteriaIncentiveV2.IncentiveCriteria memory criteria = incentive.getIncentiveCriteria();
        assertEq(uint8(criteria.criteriaType), uint8(SignatureType.EVENT));
        assertEq(criteria.signature, keccak256("Transfer(address,address,uint256)"));
        assertEq(criteria.fieldIndex, 2);
        assertEq(criteria.targetContract, address(mockAsset));
        assertEq(uint8(criteria.valueType), uint8(ValueType.WAD));
    }

    ////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.topup
    ////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.getComponentInterface
    //////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////
    // ERC20PeggedVariableCriteriaIncentiveV2.supportsInterface
    //////////////////////////////////////////////////
