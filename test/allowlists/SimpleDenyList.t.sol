...
import {SimpleDenyList} from "src/allowlists/SimpleDenyList.sol";
...
contract SimpleDenyListTest is Test {
    ...
    function testInitializer_AlreadyInitialized() public {
        ...
        denyList.initialize(LibZip.cdCompress(abi.encode(address(this), new address[](0))));
    }
    ...
    function testIsAllowed_UnnecessaryData() public {
        ...
        assertTrue(denyList.isAllowed(address(2), abi.encodePacked(uint8(42), keccak256("unexpected"), "data!!1!one1!")));
    }
