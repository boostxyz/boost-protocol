...
export interface ACGDAIncentive$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "ACGDAIncentive",
  "sourceName": "contracts/incentives/CGDAIncentive.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/incentives/CGDAIncentive.sol:ACGDAIncentive",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<ACGDAIncentive$Type["abi"]>>;
