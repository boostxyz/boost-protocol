...
contract PayableLimitedSignerValidatorTest is Test {
    struct TestParams {
        uint256 boostId;
        uint256 incentiveId;
    ...
    function setUp() public {
        ...
        clonedValidator = PayableLimitedSignerValidator(LibClone.clone(address(baseValidator)));
    ...
    function createTestParams(uint8 incentiveQuantity) internal view returns (TestParams memory params) {
        params.boostId = 1;
        ...
        params.msgHash =
            validator.hashSignerData(params.boostId, params.incentiveQuantity, claimant, params.incentiveData);
        ...
        ASignerValidator.SignerValidatorInputParams memory validatorData =
            ASignerValidator.SignerValidatorInputParams(signer, params.signature, params.incentiveQuantity);

        // Create claim data
        params.claimData = abi.encode(IBoostClaim.BoostClaimData(abi.encode(validatorData), params.incentiveData));
    }
    ...
    function testMaxClaimsPerUser() public {
        ...
        params2.msgHash =
            validator.hashSignerData(params2.boostId, params2.incentiveQuantity, claimant2, params2.incentiveData);
        ...
        ASignerValidator.SignerValidatorInputParams memory validatorData2 =
            ASignerValidator.SignerValidatorInputParams(signer, params2.signature, params2.incentiveQuantity);

        // Create claim data for claimant2
        params2.claimData = abi.encode(IBoostClaim.BoostClaimData(abi.encode(validatorData2), params2.incentiveData));
    ...
    function testInvalidSignature() public {
        ...
        ASignerValidator.SignerValidatorInputParams memory validatorData =
            ASignerValidator.SignerValidatorInputParams(signer, signature, incentiveQuantity);
    ...
    function testSupportsInterface() public view {
        assertTrue(validator.supportsInterface(type(APayableLimitedSignerValidator).interfaceId));
    }

    function testGetComponentInterface() public view {
        assertEq(validator.getComponentInterface(), type(APayableLimitedSignerValidator).interfaceId);
    }
    ...
    function testClonedValidatorBehavior() public {
        ...
        params.msgHash =
            clonedValidator.hashSignerData(params.boostId, params.incentiveQuantity, claimant, params.incentiveData);
        (uint8 v, bytes32 r, bytes32 s) = vm.sign(signerKey, params.msgHash);
        params.signature = abi.encodePacked(r, s, v);
