...
export interface AERC20Incentive$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "AERC20Incentive",
  "sourceName": "contracts/incentives/ERC20Incentive.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/incentives/ERC20Incentive.sol:AERC20Incentive",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<AERC20Incentive$Type["abi"]>>;
