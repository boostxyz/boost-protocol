...
try {
  ...
  if (!changesets.edited) {
    warn(
      `Are you sure you want to be submitting a change without including a changeset? Please see [the publishing section of the README](https://github.com/rabbitholegg/boost-protocol?tab=readme-ov-file#changesets--publishing)`,
    );
  }
} catch (e) {
