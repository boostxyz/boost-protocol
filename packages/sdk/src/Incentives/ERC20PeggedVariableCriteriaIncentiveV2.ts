...
import { SignatureType, type ValueType } from '../Actions/EventAction';
import type {
  DeployableOptions,
...
import type { GetIncentiveScalarParams } from './ERC20VariableCriteriaIncentive';
 ...
 *
 * @export
 * @class Erc20PeggedVariableCriteriaIncentiveV2
 * @typedef {ERC20PeggedVariableCriteriaIncentiveV2}
...
> {
  ...
  /**
   * Builds the claim data for the ERC20PeggedVariableCriteriaIncentiveV2Payload.
   *
   * @public
