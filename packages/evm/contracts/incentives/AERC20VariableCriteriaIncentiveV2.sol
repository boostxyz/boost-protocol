...
/// @notice Defines the structure for ERC20VariableIncentiveV2 with incentive variability criteria, without implementations
abstract contract AERC20VariableCriteriaIncentiveV2 is ERC20VariableIncentive {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(AERC20VariableCriteriaIncentiveV2).interfaceId || super.supportsInterface(interfaceId);
    }
