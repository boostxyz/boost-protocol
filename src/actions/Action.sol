...
abstract contract Action {
    ...
    function execute(bytes calldata data_) external virtual returns (bool, bytes memory);
    ...
    function validate(address user_, bytes calldata data_) external virtual returns (bool);
}
