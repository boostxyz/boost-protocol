...
contract ERC20PeggedVariableCriteriaIncentiveV2 is RBAC, AERC20PeggedVariableCriteriaIncentiveV2, IToppable {
    ...
    /// @notice Construct a new ERC20PeggedVariableCriteriaIncentiveV2
    ...
    /// @param data_ The compressed incentive parameters
    ...
    /// @param data_ The data payload for the incentive claim
    /// @dev This does not check if the recipient has already claimed the incentive
